    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                <h1 class="page-title">Gestion de Habitaciones</h1>
                <div>
                    <ol class="breadcrumb">
                                ...
                                <table class="table table-bordered text-nowrap border-bottom" id="tabla-data">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="wd-15p border-bottom-0">Nivel</th>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" name="precio" class="form-control form-control-sm" placeholder="" aria-describedby="helpId" required />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group select2-sm">
                                ...
                                <select class="form-select form-select-sm select2 select2-dropdown" name="nivel_id" required>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group select2-sm">
                                ...
                                <select class="form-select form-select-sm select2 select2-dropdown" name="tarifa_id" required>
                                    <option value="">Select...</option>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group select2-sm">
                                ...
                                <select class="form-select form-select-sm select2 select2-dropdown" name="categoria_id" required>
                                    <option value="">Select...</option>
...
<script src="{{ asset('modulo/js/configuraciones/habitaciones/habitacion-model.js') }}"></script>
<script src="{{ asset('modulo/js/configuraciones/habitaciones/habitacion-view.js') }}"></script>

<script>
    const view = new HabitacionView(new HabitacionModel(token));
    view.listar();
    view.eventos();
</script>
@endsection
