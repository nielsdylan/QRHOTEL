...
<body class="app sidebar-mini ltr light-mode">
    ...
    <div class="page">
        ...
        <div class="modal fade" id="modal-asignar-hotel">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content country-select-modal">
                    <div class="modal-header">
                        <h6 class="modal-title">Seleccione el hotel</h6><button aria-label="Close" class="btn-close"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="list-group" id="seleccionar-lista-hoteles">
    ...
    <script src="{{ asset('modulo/js/administrador/hoteles/hotel-view.js') }}"></script>
    <script src="{{ asset('modulo/js/administrador/hoteles/hotel-model.js') }}"></script>
    <script>
